...
export const getVideoProperties = (): INodeProperties[] => [
    ...
    { displayName: 'Video ID', name: 'videoId', type: 'string', displayOptions: { show: { resource: ['video'], operation: ['textToVideo'], videoMode: ['status','download'] } }, default: '', description: 'OpenAI video ID returned from Start (used for Sora/OpenAI-compatible models)' },
